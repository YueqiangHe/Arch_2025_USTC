...
// cache_write_en[3:0] four kind of ways to write values to Cache
    `define NOWRITE  4'b0000	//	Do not write Cache
    `define SB  4'b0001			//	write 8bit to Cache
    `define SH  4'b0010			//	write 16bit to Cache
    `define SW  4'b0011			//	write 32bit to Cache
// instruction encode
    // U-Type
